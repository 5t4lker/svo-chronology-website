...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="relative from-primary/10 via-background to-secondary/10 px-4 bg-transparent mx-0 py-[1px]">
        <div className="container mx-auto text-center py-0 my-[34px] bg-transparent">
